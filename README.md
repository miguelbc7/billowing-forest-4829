...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/billowing-forest-4829)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/billowing-forest-4829
```

A live public deployment of this template is available at [https://billowing-forest-4829.templates.workers.dev](https://billowing-forest-4829.templates.workers.dev)
